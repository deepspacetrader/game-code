        ...
        <>
            ...
            <div className="inventory grid">
                {inventory.map((item) => {
                    ...
                    return (
                        <div key={item.name} className="cell inv-item">
                ...
                {detailItem && (
                    <div className="item-detail-popup">
                        ...
                        <ul>
                            <li>Base Price: {detailItem.basePrice}</li>
                            <li>Delivery Time: {detailItem.deliveryTime}</li>
                            <li>Duration: {detailItem.duration.join(' - ')}</li>
                            <li>Effects:</li>
                            <ul>
                                {Object.entries(detailItem.effects).map(([key, val]) => (
                                    <li key={key}>
                                        {key}: {val}
                                    </li>
                                ))}
