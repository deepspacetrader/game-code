...
// Test data
const mockDisplayCells = Array(9).fill(null).map((_, i) => ({
  id: `item-${i}`,
  name: `Item ${i}`,
  price: 100 * (i + 1),
  quantity: i + 1
...
describe('TradingArea', () => {
  ...
  it('toggles between MarketGrid and QuantumHover based on quantumBuyEnabled', () => {
    // Initial render with quantumBuyEnabled = false
    renderTradingArea({
      quantumInventory: ['QuantumHover'],
      quantumBuyEnabled: false,
      quantumAbilitiesEnabled: true
