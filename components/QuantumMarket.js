...
const QuantumMarket = () => {
    ...
    const getAveragePurchasePrice = useCallback((itemName) => {
    ...
    const calculatePotentialProfit = useCallback((item) => {
    ...
    }, [buyPercentage, credits, displayCells, handleBuyClick, isUnlocked, calculatePotentialProfit]);
